...
class VisionViewController: ViewController {
    ...
    private let visionQueue = DispatchQueue(label: "com.example.apple-samplecode.Flower_Classifier.serialVisionQueue")
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "Flower_Classifier", withExtension: "mlmodelc") else {
